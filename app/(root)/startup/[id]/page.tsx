...
const page = async ({ params }: { params: { id: string } }) => {
  ...
  const [post, { select: editorPosts }] = await Promise.all([
    ...
    client.fetch(COLLECTION_BY_SLUG_QUERY, {
      slug: "top-picks",
    }),
  ]);
  // const post = await client.fetch(STARTUP_BY_ID_QUERY, { id });

  // const { select: editorPosts } = await client.fetch(COLLECTION_BY_SLUG_QUERY, {
  //   slug: "top-picks",
  // });
  ...
  return (
    <>
      ...
      <section className="section_container">
        ...
        />
        <div className="space-y-5 mt-10 max-w-4xl mx-auti">
